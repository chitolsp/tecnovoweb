...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { articulos: @producto.articulos, cantidad: @producto.cantidad, descripcion: @producto.descripcion, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { articulos: @producto.articulos, cantidad: @producto.cantidad, descripcion: @producto.descripcion, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
